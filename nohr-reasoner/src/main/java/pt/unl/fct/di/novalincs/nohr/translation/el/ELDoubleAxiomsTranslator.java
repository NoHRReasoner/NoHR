 ...
 * negative meta-predicate functor) of the EL <sub>&perp;</sub> <sup>+</sup> axioms translations (see <a>A Correct EL Oracle for NoHR
 * (Technical Report)</a>).
 *
 * @author Nuno Costa
 */
class ELDoubleAxiomsTranslator extends ELAxiomsTranslator {
	...
	/**
	 * Translate a role chain subsumption axiom to a set of double rules according to <b>(r2)</b> of <b>Definition 13.</b> of <a>A Correct EL
	 ...
	 * <b>Definition 13.</b> of <a>A Correct EL Oracle for NoHR (Technical Report)</a> .
	 *
	 * @param c
	...
	/**
	 * Translate a role subsumption axiom to a set of double rules according to <b>(r1)</b> of <b>Definition 13.</b> of <a>A Correct EL Oracle
	...
	/**
	 * Translate an role composition to a list of atoms according to <b> Definition 12.</b> of <a>A Correct EL Oracle for NoHR (Technical
	...
	/**
	 * Translate an atomic concept to an atom according according to <b> Definition 12.</b> of <a>A Correct EL Oracle for NoHR (Technical
	...
	/**
	 * Translate a concept to a list of atoms according according to <b> Definition 12.</b> of <a>A Correct EL Oracle for NoHR (Technical
	...
	/**
	 * Translate an atomic role to an atom according to <b> Definition 12.</b> of <a>A Correct EL Oracle for NoHR (Technical Report)</a>.
	...
	/**
	 * Translate a concept assertion to a set of double rules according to <b>(a1)</b> of <b>Definition 13.</b> of <a>A Correct EL Oracle for
	...
	/**
	 * Translate a role assertion to a set of double rules according to <b>(a2)</b> of <b>Definition 13.</b> of <a>A Correct EL Oracle for NoHR
	 * (Technical Report)</a>.
	 *
	 * @param assertion
