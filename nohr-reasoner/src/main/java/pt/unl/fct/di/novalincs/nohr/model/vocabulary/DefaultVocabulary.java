...
/**
 * An implementation of {@link Vocabulary} where the concrete representations of concepts and rules are their IRI fragments and label annotation
 * values (see {@link <a href="http://www.w3.org/TR/owl2-syntax/#Annotation_Properties">Annotation Properties</a>}); and the concrete representations
 * of the individuals are their IRI fragments, when they are named, or their node IDs, otherwise.
 *
 * @author Nuno Costa
 */
public class DefaultVocabulary implements Vocabulary {
	...
	/** The new entities (concepts and roles) counter which ensures that the generated concepts and roles are different from each other */
	...
	/** The {@link OWLOntologyChangeListener} that handles concept, role, or individual addition or remotion */
	...
	/** The imports closure of the ontology component of the Hybrid KB of wich this {@link Vocabulary} is vocabulary */
	private final Set<OWLOntology> ontologies;

	/** A mapping between symbols and {@link HybridConstant constants} that they represent. */
	private final Map<String, HybridConstantWrapper> constants;

	/** A mapping between concepts and {@link HybridPredicate predicates} representing that concepts */
	...
	/** A mapping between individuals and {@link HybridConstant constants} representing that individuals */
	private final Map<OWLIndividual, IndividualConstantImpl> individualConstants;

	/** The {@link VocabularyChangeListener listeners} that listen this {@link Vocabulary} */
	...
	/**
	 * Sets what {@link HybridConstant constant} is represented by a certain concert representation.
	 *
	 * @param repr
	 *            a concrete representation.
	 * @param constant
	 *            the constant that will be associate with {@code repr}.
	 * @param change
	 *            specifies whether the constant associated with {@code repr} will change if a constant is already associated with {@code repr}.
	...
	/**
	 * Sets what {@link HybridPredicate predicate} is represented by a certain concert representation.
	 *
	 * @param repr
	 *            a predicate representation.
	 * @param predicate
	 *            the predicate that will be associate with {@code repr}.
	 * @param change
