...
/**
 * Implementing class of {@link ELAxiomsTranslator} to handle the original part
 * (i.e. the rules with original meta-predicates) of the EL
 * <sub>&perp;</sub><sup>+</sup> axioms translations (see {@link <a>A Correct EL
 * Oracle for NoHR (Technical Report)</a>}).
 *
 * @author Nuno Costa
 */
class DLOriginalAxiomsTranslator extends DLAxiomsTranslator {

    DLOriginalAxiomsTranslator(Vocabulary v) {
        super(v);
    }

    /**
     * Translate a role chain subsumption axiom to a set of original rules
     ...
     * @retrun <i>{ S(x, x<sub>k</sub>)&larr; tr(R<sub>1k</sub>, x,
     * x<sub>k</sub>) }</i>.
     */
    @Override
    ...
    /**
     * Translate a concept subsumption axiom to a set of original rules
     * according to <b>(t1)</b>, <b>(c1)</b> and <b>(i1)</b> and <b>(i2)</b> of
    ...
    /**
     * Translate a role subsumption axiom to a set of original rules according
     * to <b>(r1)</b> of <b>Definition 13.</b> of {@link <a>A Correct EL Oracle
     ...
     * @return <i>[R<sub>1</sub>(x, x<sub>1</sub>), ..., R<sub>k</sub>
     * (x<sub>k-1</sub> , x<sub>k</sub>)]</i>.
     */
    ...
    /**
     * Translate a role assertion to a set of original rules according to
