...
/**
 * Implementing class of {@link ELAxiomsTranslator} to handle the double part
 * (i.e. the rules with double meta-predicates and those whose heads have a
 * negative meta-predicate functor) of the EL <sub>&perp;</sub> <sup>+</sup>
 * axioms translations (see {@link <a>A Correct EL Oracle for NoHR (Technical
 * Report)</a>}).
 *
 * @author Nuno Costa
 */
class DLDoubleAxiomsTranslator extends DLAxiomsTranslator {

    DLDoubleAxiomsTranslator(Vocabulary v) {
        super(v);
    }

    /**
     * Obtains the negated atom (i.e. with a negative meta-predicate) of a given
     * literal.
     *
     * @param b a literal <i>M(t<sub>1</sub>,...,t<sub>n</sub>)</i> or
     * <i><b>not</b> M(t<sub>1</sub>,...,t<sub>n</sub>)</i> where <i>M</i> is a
     * predicate <i>P</i> or a meta-predicate <i>NP</i>, <i>DP</i>, <i>RP</i>,
     * <i>DP<sup>d</sup></i> or <i>RP<sup>d</sup>.
    ...
    /**
     * Translate a role chain subsumption axiom to a set of double rules
     * according to <b>(r2)</b> of <b>Definition 13.</b> of {@link <a>A Correct
     * EL Oracle for NoHR (Technical Report)</a>} .
     *
     * @param chain a role chain <i>R<sub>1</sub>&#x26AA; ...
     * &#x26AA;R<sub>k</i>.
     * @param s the subsuming role <i>S</i>
    ...
    /**
     * Translate a concept subsumption axiom to a set of double rules according
     * to <b>(t1)</b>, <b>(c1)</b> and <b>(i1)</b> and <b>(i2)</b> of
     * <b>Definition 13.</b> of {@link <a>A Correct EL Oracle for NoHR
     * (Technical Report)</a>} .
     *
     * @param c the subsumed concept expression <i>C</i>.
     * @param a the subsuming concept <i>A</i>.
     * @return see: <br>
     * line 2 of <b>(t1)</b>; <br>
    ...
    /**
     * Translate a role subsumption axiom to a set of double rules according to
     * <b>(r1)</b> of <b>Definition 13.</b> of {@link <a>A Correct EL Oracle for
     * NoHR (Technical Report)</a>} .
     *
     * @param r the subsumed role <i>R</i>.
     * @param s the subsuming role <i>S</i>.
    ...
    Set<Rule> subsumptionTranslation(OWLPropertyExpression r, OWLPropertyExpression s) {
        return ruleSet(rule(tr((OWLProperty) r, X, Y), tr((OWLProperty) s, X, Y), negLiteral(negTr((OWLProperty) r, X, Y))),
                rule(negTr((OWLProperty) r, X, Y), negTr((OWLProperty) s, X, Y)));
    }
     ...
     * R<sub>k</sub><sup>d</sup>(x<sub>k-1</sub>, x<sub>k</sub>)]</i>.
     */
     ...
     * @param x a variable <i>x</i>.
     * @return <i>{A<sup>d</sup>(x)}</i> if <i>C</i> is an atomic concept
     * <i>A</i>; <br>
     * <i>{}</i> if <i>C</i> is the top concept &#x22A5; <br>
     * <i>tr(C<sub>1</sub>, x)<sup>d</sup> &cup; tr(C<sub>2</sub>,
     * x)<sup>d</sup> if <i>C</i> is an conjunction <i>C<sub>1</sub> &sqcap;
     * <i>C
     * <sub>2</sub></i>; </br>
     * <i>{R<sup>d</sup>(x, x<sub>1</sub>)} &cup; tr(D,
     * x<sub>1</sub>)<sup>d</sup></i> if <i>C</i> is an existential
     * <i>&exist;R.D</i> <br>
     * .
     */
    ...
    /**
     * Translate a concept assertion to a set of double rules according to
     * <b>(a1)</b> of <b>Definition 13.</b> of {@link <a>A Correct EL Oracle for
     * NoHR (Technical Report)</a>}.
     *
     ...
     * <b>(a2)</b> of <b>Definition 13.</b> of {@link <a>A Correct EL Oracle for
     * NoHR (Technical Report)</a>}.
     *
     * @param assertion an assertion <i>R(a, b)</i>.
