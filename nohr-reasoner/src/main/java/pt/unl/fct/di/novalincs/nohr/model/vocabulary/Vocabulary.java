...
/**
 * Defines a <i>Hybrid Knowledge Base vocabulary</i> - the set of predicates and constants appearing in that KB. Is responsable for: <br>
 * - maintain the {@link HybridPredicate predicates} and {@link HybridConstant constants} representing <i>concepts</i>, <i>roles</i> or
 * <i>individuals</i>, respectively, of the ontology component, and returning them, given their concert representations; <br>
 * - construct and maintain new (rule) {@link HybridPredicate predicates} and {@link HybridConstant constants}, given their ( {@link String}) symbols.
 * <br>
 * <br>
 * Additionally a {@link Vocabulary} can generate new concepts or rules that doesn't appear in the ontology. <br>
 * <br>
 * Each {@link HybridPredicate predicate} and {@link HybridConstant constant} is associated with the concrete representation with which it was
 * obtained. What those concrete representations represent can change over time. Consider the following example. At some moment the ontology can
...
public interface Vocabulary {
	...
	/**
	 * Obtainss a constant representing a specified symbol. If the symbol is a number, then the created constant is an numeric constant.
	 *
	 * @param symbol
	 *            the symbol.
	...
	/**
	 * Returns the ontology component of the Hybrid Knowledge Base of which this {@link Vocabulary} is vocabulary.
	 *
	 * @return the ontology component of the Hybrid Knowledge Base of which this {@link Vocabulary} is vocabulary.
	 */
	...
	/**
	 * Obtains a negative meta-predicate from a specified predicate symbol and predicate arity.
	 *
	 * @param symbol
	 *            a symbol, <i>S</i>.
	 * @param arity
	...
	/**
	 * Obtains a meta-predicate from a specified predicate symbol and predicate arity.
	 *
	 * @param symbol
	 *            a predicate <i>S</i>.
	 * @param arity
	...
	/**
	 * Obtains a meta-predicate from a specified predicate symbol and predicate arity with a specified type.
	 *
	 * @param symbol
	 *            a predicate symbol <i>S</i>.
	 * @param arity
