...
public class RightSomeValuesFromNormalizer implements Normalizer<OWLSubClassOfAxiom> {

    private final OntologyUtil util;
    private final Vocabulary vocabulary;

    public RightSomeValuesFromNormalizer(OntologyUtil util, Vocabulary vocabulary) {
        this.util = util;
