...
/**
 * Represents an <i>EL<sub>\u22A5</sub><sup>+</sup></i> normalized, reduced and simplified ontolology, according to <b>Definition 6.</b>, and
 * respective assumed normalizations, and some of the simplifications assumed in the <b>Definition 12.</b> of <a>A Correct EL Oracle for NoHR
 * (Technical Report)</a>. A reduced ontology of an <i>EL<sub>\u22A5</sub><sup>+</sup></i> ontology <i>O</i> is an ontology <i>O'</i> composed by -
 ...
 * -concept subsumptions <i>C  \u2291 A</i>; <br>
 * -role subsumptions <i>R  \u2291 S</i>; <br>
 * -role chain subsumptions <i>R<sub>1</sub> \u2218 ...  \u2218R<sub>n</sub>  \u2291 S </i><br>
 * that entails exactly the same membership assertions that <i>O</i>, i.e. <i>O \u22A2 A(a)</i> iff <i>O' \u22A2 A(a)</i> and <i>O \u22A2 R(a,b)</i> iff
 * <i>O' \u22A2 R(a,b)</i>.
 *
 * @author Nuno Costa
 */
public interface ELOntologyReduction {
	...
	/**
	 * Returns the role chain subsumptions <i>R<sub>1</sub> \u2218 ...  \u2218S<sub>n</sub>  \u2291 A</i> in this
	 * {@link ELOntologyReduction reduction}.
	 *
	 * @return Returns the role chain subsumptions <i>R<sub>1</sub> \u2218 ...  \u2218S<sub>n</sub>  \u2291 A</i> in this
	 *         {@link ELOntologyReduction reduction}.
	 */
	...
	/**
	 * Returns the concept subsumptions <i>C  \u2291 A</i> in this {@link ELOntologyReduction reduction}.
	 *
	 * @return the concept subsumptions <i>C  \u2291 A</i> in this {@link ELOntologyReduction reduction}.
	 */
	...
	/**
	 * Returns the role subsumptions <i>R  \u2291 S</i> in this {@link ELOntologyReduction reduction}.
	 *
	 * @return the role subsumptions <i>R  \u2291 S</i> in this {@link ELOntologyReduction reduction}.
	 */
