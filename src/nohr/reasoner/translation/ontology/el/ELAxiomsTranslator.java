package nohr.reasoner.translation.ontology.el;
...
import nohr.reasoner.translation.ontology.EquivalentClass;
...
public class ELAxiomsTranslator {
     ...
     *
     * @param owlClassExpressions the owl class expressions
     ...
     *
     * @param owlClass        the owl class
     * @param rightPartOfRule the right part of rule
     */
     ...
     *
     * @param owlClassAxiom the owl class axiom
     */
    ...
    public void writeRuleA2(OWLAxiom entity) {
        currentRule = "%A2";
        String R = ontologyLabel.getLabel(entity, 1), a = ontologyLabel.getLabel(entity, 2), b = ontologyLabel.getLabel(entity, 3);
