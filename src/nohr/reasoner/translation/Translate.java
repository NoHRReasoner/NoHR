...
import nohr.reasoner.translation.ontology.el.ELAxiomsTranslator;
import nohr.reasoner.translation.ontology.el.ELOntologyTranslator;
...
import nohr.reasoner.translation.ontology.ql.QLOntologyTranslator;
...
public class Translate {
	 ...
	 */
	public Translate(OWLOntologyManager owlModelManager, OWLOntology ontology,
			OWLReasoner owlReasoner) throws IOException,
...
//		Utils.getDiffTime(dateStart, "Retrieving inferred information: ");
	...
	private void initCollections() throws OWLOntologyCreationException,
		...
		case DL_LITE_R:
			...
			QLAxiomsTranslator ruleCreatorQL = new QLAxiomsTranslator(cm, ontologyLabel,
