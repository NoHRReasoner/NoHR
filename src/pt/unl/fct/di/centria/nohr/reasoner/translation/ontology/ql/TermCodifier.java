...
public class TermCodifier {
    ...
    private final OntologyLabeler ontologyLabel;
	...
	final String pred = prefix + ontologyLabel.getLabel(prop, 1);
	return new TermModel(pred);
    }

    public TermModel getNegativePredicate(OWLClass cls) {
	final String pred = CLASSICAL_NEGATION_PREFIX
	...
	final String pred = (doubled ? DOUBLED_PREFIX : ORIGINAL_PREFIX)
		+ ontologyLabel.getLabel(cls, 1);
	return new TermModel(pred);
    }
