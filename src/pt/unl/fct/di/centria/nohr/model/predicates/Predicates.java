 ...
 * {@link <a href=
 * https://docs.oracle.com/javase/1.5.0/docs/guide/language/static-import.html>Static
...
public class Predicates {
    ...
    /**
     * Create a double meta-predicate from a specified predicate symbol and
     * predicate arity.
     *
     * @param symbol
     *            a predicate symbol, <i>S</i>.
     * @param arity
     *            the arity, <i>n</i>, of the predicate that {@code symbol}
     *            represents.
     ...
     *
     * @param predicate
     *            a predicate <i>P</i> or a meta-predicate <i>NP</i>, <i>DP</i>,
     *            <i>RP</i>, <i>DP<sup>d</sup></i> or <i>RP<sup>d</sup></i>.
    ...
    /**
     * Create a negative meta-predicate from a specified predicate symbol and
     * predicate arity.
     *
     * @param symbol
     *            a symbol, <i>S</i>.
    ...
    /**
     * Create an original meta-predicate from a specified predicate symbol and
     * predicate arity.
     *
     * @param symbol
     *            a predicate symbol <i>S</i>.
     ...
     *            a concept <i>A</i>.
     * @param type
     *            a type. Shoudln't represent a quantification (i.e.
     *            {@code type.}{@link PredicateType#isQuantification()
     *            isQuantification()} must be false).
     * @return <i>A</i> if {@code type} is {@link PredicateType#ORIGINAL
     *         original}; <br>
     *         <i>A<sup>d</sup></i> if {@code type} is
     *         {@link PredicateType#DOUBLE double}; <br>
     *         <i>NA</i> if {@code type} is {@link PredicateType#NEGATIVE
     *         negative}.
     *
     * @throws IllegalArgumentException
     *             if {@code type.}{@link PredicateType#isQuantification()
     *             isQuantification()} is true.
     */
     ...
     * @param type
     *            a type.
     * @return <i>P</i> if {@code type} is {@link PredicateType#ORIGINAL
     *         original}; <br>
     *         <i>P<sup>d</sup></i> if {@code type} is
     *         {@link PredicateType#DOUBLE double}; <br>
     *         <i>NP</i> if {@code type} is {@link PredicateType#NEGATIVE
     *         negative}; <br>
     *         <i>DP</i> if {@code type} is {@link PredicateType#ORIGINAL_DOMAIN
     *         original domain}; <br>
     *         <i>RP</i> if {@code type} is {@link PredicateType#ORIGINAL_RANGE
     *         original range} ; <br>
     ...
     * @return a predicate, <i>S/n</i> with symbol {@symbol} and arity
     *         {@code arity}.
     */
    ...
    /**
     * Create a meta-predicate from a specified predicate symbol and predicate
     * arity.
     *
     * @param symbol
     *            a predicate <i>S</i>.
     ...
     *            a predicate arity <i>n</i>.
     * @param type
     *            the type of the meta-predicate. Shoudn't represent a
     *            quantification (i.e. {@code type.}
     *            {@link PredicateType#isQuantification() isQuantification()}
     *            must be false).
     * @return <i>S/n</i> if {@code type} is {@link PredicateType#ORIGINAL
     *         original}; <br>
     *         <i>S<sup>d</sup>/n</i>, if {@code type} is
     *         {@link PredicateType#DOUBLE double}; <br>
     *         <i>NS/n</i>, if {@code type} is {@link PredicateType#NEGATIVE
     *         negative}.
     *
     * @throw IllegalArgumentException if {@code type.}
     *        {@link PredicateType#isQuantification() isQuantification()} is
     *        true.
     */
    ...
    /**
     * Create the predicate represented by a specified symbol with a specified
     * arity, given a specified {@link VocabularyMapping}.
     *
     * @param symbol
     *            a symbol <i>S</i>.
     * @param arity
     ...
     * @return the predicate representing a concept <i>A</i> if {@code arity} is
     *         {@literal 1} and {@code vocabularyMapping.}
     *         {@link VocabularyMapping#getConcept(String) getConcept(symbol)}
     *         returns <i>A</i>; <br>
     *         the predicate representing a role <i>P</i> if {@code arity} is
     *         {@literal 2} and {@code vocabularyMapping.}
     *         {@link VocabularyMapping#getRole(String) getRole(symbol)} returns
     *         the role <i>P</i>; <br>
     *         the predicate represented by {@code symbol} with arity
     *         {@code arity}, otherwise.
     */
