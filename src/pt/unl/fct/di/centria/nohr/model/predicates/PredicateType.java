 ...
 *
 * Each type has a marker char to prefix the symbols of meta-predicates of that
 * type: {@code 'a', 'd', 'n', 'e', 'f', 'g'}, and {@code 'h'}, respectively.
 *
 * Note that the meta-predicates of the types that represent existential
 * (original domain, original range, double domain and double range) have always
 * arity {@literal 1}, unlike the other meta-predicates which have the same
 * arity that the predicate that they refer - {@link #isQuantification()} allows
...
public enum PredicateType {
    ...
    ORIGINAL('a'), /**
		    ...
		    */
    ORIGINAL_DOMAIN('e', false,
	    true), /**
		    * The type of an original meta-predicate, <i>RP</i>,
		    * representing an existential quantification of an atomic
