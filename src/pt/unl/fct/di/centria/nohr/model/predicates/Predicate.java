...
/**
 * Represents a predicate. Can be a rule predicate or represent a concept, a
 * role or a meta-predicate (see {@link MetaPredicate}) in the translation of an
 * ontology.
 *
 * @author Nuno Costa
 *
...
public interface Predicate extends FormatVisitable {
    ...
    /**
     * Returns the signature of this predicate, i.e. the pair
     * {@code symbol/arity}.
     *
    ...
    /**
     * Returns true iff this predicate does't represent a concept, a role or a
     * meta-predicate.
     *
     * @return true iff this predicate represents does't represent a concept, a
     *         role or a meta-predicate.
     */
