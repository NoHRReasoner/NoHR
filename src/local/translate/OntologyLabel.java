 ...
 * Parsing the properties to get label
 */
public class OntologyLabel {
     ...
     * Gets the label.
     *
     * @param entity    the axiom
     * @param numInList the num in list
     * @return the label
     */
     ...
     * Gets the label.
     *
     * @param owlClass  the owl class expression
     * @param numInList the num in list
     * @return the label
     */
     ...
     * Gets the label.
     *
     * @param member    the owl individual
     * @param numInList the num in list
     * @return the label
     */
     ...
     *
     * @param owlClassExpression the owl class expression
     * @param localIterator      the local iterator
        ...
        switch (owlClassExpression.getClassExpressionType()) {
            case OWL_CLASS: {
                if (!(owlClassExpression.isOWLThing() || owlClassExpression.isOWLNothing())) {
                    equivalentClass.addRule(getLabel(owlClassExpression, 1), localIterator, iterator, EquivalentClass.OntologyType.ONTOLOGY);
                }
                break;
            }
