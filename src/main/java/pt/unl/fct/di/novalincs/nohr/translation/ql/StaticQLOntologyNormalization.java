...
/**
 * The implementation of {@link QLOntologyNormalization}. This {@link QLOntologyNormalization} is static in the sense that can represent only the
 * normalization of an ontology in a given moment; if the ontology changes other {@link StaticQLOntologyNormalization} must be constructed.
 *
 * @author Nuno Costa
 */
