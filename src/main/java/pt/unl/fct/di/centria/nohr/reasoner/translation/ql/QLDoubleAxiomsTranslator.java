 ...
 * negative meta-predicate functor) of the DL-Lite<sub>R</sub> axioms translations (see
...
public class QLDoubleAxiomsTranslator extends QLAxiomsTranslator {
	...
	/**
	 * Translate a role assertion to a set of double rules according to <b>(a2)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>}.
	 *
	 * @param assertion
	...
	/**
	 * Translate a DL-Lite<sub>R</sub> negative concept subsumption axiom to a set of double rules according to <b>(n1)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param b1
	 ...
	 * @throws IllegalArgumentException
	 *             if <i>B<sub>1</sub></i> or <i>B<sub>2</su></i> aren't DL-Lite<sub>R</sub> basic concepts.
	 */
	public Set<Rule> disjunctionTranslation(OWLClassExpression b1, OWLClassExpression b2) {
	...
	/**
	 * Translate a DL-Lite<sub>R</sub> negative role subsumption axiom to a set of double rules according to <b>(n2)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param q1
	 ...
	 * @return <i>{tr(&not;Q<sub>1</sub>, x, y)&larr;tr(&not;Q<sub>2</sub>, x, y),<br>
	 ...
	 */
	public Set<Rule> disjunctionTranslation(OWLPropertyExpression<?, ?> q1, OWLPropertyExpression<?, ?> q2) {
	 ...
	 * @return <i>{tr<sup>d</sup>(&exist;Q<sub>2</sub>, x)&larr;tr<sup>d</sup>(&exist;Q<sub>1</sub></i>, x)}</i>.
	 */
	@Override
	public Rule domainSubsumptionTranslation(OWLObjectPropertyExpression q1, OWLObjectPropertyExpression q2) {
		return rule(existTr(q2, X), existTr(q1, X), negLiteral(negTrExist(q2, X), true));
	}

	/**
	 * Translate the meaning of a domain meta-predicate to a set of double rules according to <b>(e)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param p
	 *            a role <i>P</i>.
	...
	/**
	 * Translate the existential quantification of a given DL-Lite<sub>R</sub> role to a double atom (see <b>Definition 5.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>}).
	 *
	 * @param q
	 ...
	 * @param x
	 *            a variable <i>x</i>.
	 * @return <i>DP<sup>d</sup>(x)</i> if <i>Q</i> is an atomic role<i>P</i>; <br>
	 *         <i>RP<sup>d</sup>(x)</i> if <i>Q</i> in an inverse role<i>P<sup>-</sup></i>.
	 * @throws IllegalArgumentException
	...
	/**
	 * Translate the range subsumption entailed by a given role subsumption to set of double rules according to <b>(s2)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param q1
	 *            a DL-Lite<sub>R</sub> basic role <i>Q<sub>1</sub></i>.
	 * @param q2
	 *            a DL-Lite<sub>R</sub> basic role <i>Q<sub>2</sub></i>.
	 * @return <i>tr<sup>d</sup>(&exist;Q<sub>2</sub><sup>-</sup>, x)&larr;tr<sup>d</sup>(&exist;Q<sub>1</sub><sup>-</sup>, x)</i>.
	 */
	@Override
	public Rule rangeSubsumptionTranslation(OWLObjectPropertyExpression q1, OWLObjectPropertyExpression q2) {
		return rule(existTr(q2, X), existTr(q1, X), negLiteral(negTrExist(q2, X), true));
	}

	/**
	 * Translate the meaning of a range meta-predicate to a set of double rules according to <b>(e)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param p
	 *            a role <i>P</i>.
	...
	/**
	 * Translate a DL-Lite<sub>R</sub> concept subsumption axiom to a set of double rules according to <b>(s1)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param b1
	 ...
	 * @return <i>tr<sup>d</sup>(B<sub>2</sub>, x)&larr;</i> if <i>B<sub>1</sub></i> is the top concept <i>&top;</i><br>
	 *         {tr<sup>d</sup>(B<sub>2</sub>, x)&larr;tr<sup>d</sup>(B<sub>1</sub>, x)}</i>.
	 * @throws IllegalArgumentException
	 *             if <i>B<sub>1</sub></i> or <i>B<sub>2</sub></i> aren't DL-Lite<sub>R</sub> basic concepts.
	 */
	@Override
	public Set<Rule> subsumptionTranslation(OWLClassExpression b1, OWLClassExpression b2) {
		if (b1.isOWLThing())
	 ...
	 */
	@Override
	public Set<Rule> subsumptionTranslation(OWLPropertyExpression<?, ?> q1, OWLPropertyExpression<?, ?> q2) {
	...
	/**
	 * Translate a given DL-Lite<sub>R</sub> concept to a double atom (see <b>Definition 5.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>}).
	 *
	 * @param b
	 *            a DL-Lite<sub>R</sub> concept <i>B</i>.
	 * @param x
	 *            a variable <i>x</i>.
	 * @return <i>A<sup>d</sup>(x)</i> if <i>B</i> is an atomic concept <i>A</i>; <br>
	 *         <i>DP<sup>d</sup>(x)</i> if <i>B</i> in an existential <i>&exist;P</i>; <br>
	 *         <i>RP<sup>d</sup>(x)</i> if <i>B</i> is an existential <i>&exist;P<sup>-</sup></i>.
	 * @throws IllegalArgumentException
	...
	/**
	 * Translate a given DL-Lite<sub>R</sub> role to a double atom (see <b>Definition 5.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>}).
	 *
	 * @param r
	...
	/**
	 * Translate a DL-Lite<sub>R</sub> role unreflexivity according to <b>(ir)</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param p
	 *            the irreflexive role <i>P</i>.
	 * @return <i>NP(x, x)</i>.
	 */
	public Rule unreflexivityTranslation(OWLObjectProperty p) {
		return rule(negTr(p, X, X));
	}

	/**
	 * Translate a DL-Lite<sub>R</sub> concept unsatisfiability to a set of rules according to <b>(i1)</b> of <b>Definition 9.</b> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param a
	 ...
	 * @return <i>NA(x)</i>.
	 */
	public Set<Rule> unsatisfiabilityTranslation(OWLClass a) {
		return ruleSet(rule(negTr(a, X)));
	}

	/**
	 * Translate a DL-Lite<sub>R</sub> role unsatisfiability according to <b>(i2)</i> of
	 * {@link <a href="http://centria.di.fct.unl.pt/~mknorr/ISWC15/resources/ISWC15WithProofs.pdf">Next Step for NoHR: OWL 2 QL</a>} .
	 *
	 * @param p
	 ...
	 * @return <i>NP(x, y)</i>.
	 */
	public Set<Rule> unsatisfiabilityTranslation(OWLProperty<?, ?> p) {
