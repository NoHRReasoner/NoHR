 ...
 * program in a specified {@link DedutiveDatabaseManager}. The following properties must be satisfied, where <i>A</i> denotes an atomic concept and
...
public interface OntologyTranslator {
	...
	/**
	 * Returns the {@link DedutiveDatabaseManager} where this {@link OntologyTranslator translator} load the translation.
	 *
	 * @return the {@link DedutiveDatabaseManager} where this {@link OntologyTranslator translator} load the translation.
	 */
