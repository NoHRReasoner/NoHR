 ...
 * Pattern</a>} ) to support different model formats, i.e. string representation
 * of the model elements.
 *
 * Implement this interface if you want to support a new model formant,
 * returning the desired string representation of each model element, in the
 * corresponding {@code visit} method.
 *
 * @see FormatVisitable
 *
 * @author nunocosta
