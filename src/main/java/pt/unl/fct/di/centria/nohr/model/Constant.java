...
public interface Constant extends Term {
	...
	/**
	 * Returns this constant as an OWL individual if it is indeed an ontology individual.
	 *
	...
	/**
	 * Returns this constant as an ontology literal if it is indeed an ontology literal.
	 *
	...
	/**
	 * Returns the truth value corresponding to this constant if it represents a truth value
	 *
	 * @return {@link TruthValue#TRUE}, iff the string the representation of this constant is constant is {@literal "true"}; or
	 *         {@link TruthValue#UNDEFINED}, iff the string representation of this constant is {@literal "undefined"}
	 * @throws ClassCastException
	 *             if this constant isn't a rule constant or if his string representation isn't {@literal "true"} nor {@literal "undefined"}
	 */
	...
	/**
	 * Returns true iff this constant is an rule constant corresponding to a truth value, {@code true} or {@code undefined}.
	 *
	 * @return returns true iff this constant is an rule corresponding to a truth value.
	 */
