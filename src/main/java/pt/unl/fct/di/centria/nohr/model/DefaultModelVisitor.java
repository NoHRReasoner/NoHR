...
/**
 * An implementation of {@link ModelVisitor} that simply returns {@code element}
 * in each {@code visit(E element)} method if {@code E} is an leaf type (i.e.
 * {@link Constant}, {@link Predicate}, or {@link Variable}}), and
 * {@code element.accept(this)} otherwise. Extend this class if you want create
