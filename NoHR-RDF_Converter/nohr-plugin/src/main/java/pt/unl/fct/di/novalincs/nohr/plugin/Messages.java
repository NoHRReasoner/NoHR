...
public class Messages {
	...
	/**
	 * The message shown when the RDF directory has not been set yet.
	 *
	 * @param parent
	 */
    public static void rdfDirectoryNotSet(Component parent) {
		JOptionPane.showMessageDialog(parent,"Please open the Preferences panel and set the RDF directory.","RDF",JOptionPane.WARNING_MESSAGE);
    }
}
