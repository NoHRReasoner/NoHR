...
public final class NoHRPreferences {
    ...
    private static final String RDF2X_Directory = "RDF2X_DIR";
    ...
    public NoHRHybridKBConfiguration getConfiguration() {
        final NoHRHybridKBConfiguration configuration = new NoHRHybridKBConfiguration(getXsbDirectory(), getKoncludeBinary(),getRDF2xDirectory(), getDLInferenceEngineEL(), getDLInferenceEngineQL(), false, getDLInferenceEngine());
    ...
    public File getRDF2xDirectory() {
        final String pathname = getPreferences().getString(RDF2X_Directory, null);
    ...
    public void setRDF2X_Directory(File value) {
        if (value != null){
            getPreferences().putString(RDF2X_Directory,value.getAbsolutePath());
        }
    }
}
